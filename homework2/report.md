...
| 測試案例 | 輸入參數 (p1, p2)      | 預期輸出 (加法)       | 實際輸出 (加法)       | 預期輸出 (乘法)       | 實際輸出 (乘法)       |
|----------|-------------------------|-----------------------|-----------------------|-----------------------|-----------------------|
| 測試一   | (2x^2, 3x^1)            | 2x^2 + 3x^1 + 0x^0   | 2x^2 + 3x^1 + 0x^0   | 6x^3 + 0x^2           | 6x^3 + 0x^2           |
| 測試二   | (1x^1, 1x^1)            | 2x^1                  | 2x^1                  | 1x^2                  | 1x^2                  |
| 測試三   | (2x^2 + 1x^0, 3x^2)     | 5x^2 + 1x^0           | 5x^2 + 1x^0           | 6x^4 + 3x^2           | 6x^4 + 3x^2           |
